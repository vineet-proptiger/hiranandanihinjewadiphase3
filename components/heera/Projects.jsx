  ...
  return (
    <section id="projects" className="projects-section">
      ...
      <div className="container mx-auto px-4 sm:px-8 max-w-[1300px] relative z-10">
        ...
        {/* Project 1: Hiranandani Township Residential */}
        <div className="project-card-wrap flex flex-col lg:flex-row" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
          ...
          <div className="w-full lg:w-1/2 project-img-container">
            <Image
              ...
              alt="Hiranandani Hinjewadi Township - Residential Towers"
              width={700}
              height={550}
          ...
          <div className="w-full lg:w-1/2 project-content-box">
            <h3 className="project-title">HIRANANDANI TOWNSHIP - RESIDENTIAL</h3>
            <p className="project-desc">
              The residential sector of Hiranandani Hinjewadi Township on the Pune IT & Growth Corridor offers luxury 2, 3 & 4 BHK residences across a sprawling 105-acre master-planned development. Designed for elevated elegance with breathtaking views and abundant natural light, each residence is crafted with top-tier finishes. Residents enjoy seamless access to grand clubhouses, extensive open green spaces, Resort-style swimming pools, and exclusive premium amenities.
            </p>
            <button
        ...
        {/* Project 2: Hiranandani Clubhouses & Retail */}
        <div className="project-card-wrap flex flex-col lg:flex-row-reverse mb-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          ...
          <div className="w-full lg:w-1/2 project-img-container">
            <Image
              ...
              alt="Hiranandani Township - Clubhouses & Retail Boulevards"
              width={700}
              height={550}
              className="project-img"
              priority={true}
          ...
          <div className="w-full lg:w-1/2 project-content-box">
            <h3 className="project-title">TOWNSHIP CLUBHOUSES &amp; RETAIL</h3>
            <p className="project-desc">
              Complementing the luxury residences are landmark state-of-the-art clubhouses and lively retail boulevards, offering unmatched leisure, sports zones, and convenience shopping right at your doorstep. Thoughtfully planned across 105 acres, Hiranandani Hinjewadi Township exemplifies a superior way of living with grand entrance lobbies, multi-level parking, expansive open spaces, and seamless connectivity to IT hubs and tech parks in Pune.
            </p>
            <button
              className="explore-btn"
              onClick={() => setIsOpen && setIsOpen(true)}
