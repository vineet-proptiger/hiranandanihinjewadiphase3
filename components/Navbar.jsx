  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        (scrolled || mobileOpen)
          ? 'bg-[#0D3B50]/95 border-b border-[#C4952A]/20 shadow-lg'
          : 'bg-[#0D3B50]/95 border-b border-[#C4952A]/20 lg:bg-transparent lg:border-transparent lg:shadow-none'
      }`}
    >
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-[72px] lg:h-[88px]">
          ...
          <a href="#" className="flex items-center shrink-0">
            <img
              src={logoImages.main}
              alt="Hiranandani Hinjewadi Township"
