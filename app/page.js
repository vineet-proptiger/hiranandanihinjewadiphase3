...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar flex font-sans">
        <a
          id="mobile-call"
          href="tel:+919718344024"
          className="flex-1 flex flex-col items-center justify-center py-2 gap-1"
          style={{ background: '#111827', borderRight: '1px solid #334155' }}
        >
          <svg width="20" height="20" fill="#ffffff" viewBox="0 0 24 24" className="anim-ring">
            <path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z" />
          </svg>
          <span style={{ color: '#ffffff', fontSize: '11.5px', fontWeight: '600', letterSpacing: '0.04em' }}>Call Us</span>
        </a>
        
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex flex-col items-center justify-center py-2 gap-1"
          style={{ background: 'var(--color-gold)', borderRight: '1px solid rgba(0,0,0,0.1)' }}
        >
          <svg width="20" height="20" fill="none" stroke="#000000" strokeWidth="2" viewBox="0 0 24 24" className="anim-pulse-heart">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01" className="anim-typing-1" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 10h.01" className="anim-typing-2" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M16 10h.01" className="anim-typing-3" />
          </svg>
          <span style={{ color: '#000000', fontSize: '11.5px', fontWeight: '700', letterSpacing: '0.06em' }}>ENQUIRE</span>
        </button>
        ...
        >
          <svg width="20" height="20" fill="#ffffff" viewBox="0 0 24 24" className="anim-float">
          ...
          <span style={{ color: '#ffffff', fontSize: '11.5px', fontWeight: '600', letterSpacing: '0.04em' }}>WhatsApp</span>
        </a>
      </div>
