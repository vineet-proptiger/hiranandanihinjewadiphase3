...
import { galleryImages, amenityImages } from '../../lib/heera/images'

import Navbar from '../../components/heera/Navbar'
import Hero from '../../components/heera/Hero'

const Overview = dynamic(() => import('../../components/heera/Overview'), { ssr: true })
// const Projects = dynamic(() => import('../../components/heera/Projects'), { ssr: true })
const Highlights = dynamic(() => import('../../components/heera/Highlights'), { ssr: true })
const Amenities = dynamic(() => import('../../components/heera/Amenities'), { ssr: true })
const Pricing = dynamic(() => import('../../components/heera/Pricing'), { ssr: true })
const Location = dynamic(() => import('../../components/heera/Location'), { ssr: true })
const MasterPlan = dynamic(() => import('../../components/heera/MasterPlan'), { ssr: true })
// const PaymentPlan = dynamic(() => import('../../components/heera/PaymentPlan'), { ssr: true })
const AboutDeveloper = dynamic(() => import('../../components/heera/AboutDeveloper'), { ssr: true })
const QuickChat = dynamic(() => import('../../components/heera/QuickChat'), { ssr: true })
const Footer = dynamic(() => import('../../components/heera/Footer'), { ssr: true })

const Gallery = dynamic(() => import('../../components/heera/Gallery'), { ssr: false })
// const VirtualTour = dynamic(() => import('../../components/heera/VirtualTour'), { ssr: false })
const CarouselSection = dynamic(() => import('../../components/heera/CarouselSection'), { ssr: false })
// const ExclusiveAmenities = dynamic(() => import('../../components/heera/ExclusiveAmenities'), { ssr: false })
// const Sustainability = dynamic(() => import('../../components/heera/Sustainability'), { ssr: false })
// const JapaneseExcellence = dynamic(() => import('../../components/heera/JapaneseExcellence'), { ssr: false })
const EnquireModal = dynamic(() => import('../../components/heera/EnquireModal'), { ssr: false })
const AosInit = dynamic(() => import('../../components/heera/AosInit'), { ssr: false })
    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar bg-[#0f172a] items-center justify-between px-3 py-[10px] gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <a
            href="https://wa.me/919718344024?text=Hi%20Anuj%2C%20Please%20share%20the%20project%20details%20of%20Hiranandani%20Phase%203"
